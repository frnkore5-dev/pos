    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <div class="form-group d-flex justify-content-center flex-wrap mb-0">
                <button wire:click="resetCart" type="button" class="btn btn-pill btn-danger mr-3"><i class="bi bi-x"></i> {{ __('sale::messages.reset') }}</button>
                <button wire:loading.attr="disabled" wire:click="proceed" type="button" class="btn btn-pill btn-primary" {{  $total_amount == 0 ? 'disabled' : '' }}><i class="bi bi-check"></i> {{ __('sale::messages.proceed') }}</button>
            </div>
        </div>
    </div>
