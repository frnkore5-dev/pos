...
@section('title', __('user::messages.edit_role'))
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">{{ __('user::messages.update_role') }} <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="permissions">
                                    {{ __('user::messages.permissions') }} <span class="text-danger">*</span>
                                </label>
                            </div>
