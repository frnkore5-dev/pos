...
@section('title', __('purchasesreturn::messages.create_purchase_return'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('purchasesreturn::messages.add') }}</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="purchase-return-form" action="{{ route('purchase-returns.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="Pending">{{ __('purchasesreturn::messages.pending') }}</option>
                                            <option value="Shipped">{{ __('purchasesreturn::messages.shipped') }}</option>
                                            <option value="Completed">{{ __('purchasesreturn::messages.completed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">{{ __('purchasesreturn::messages.amount_received') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('purchasesreturn::messages.create_purchase_return') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
