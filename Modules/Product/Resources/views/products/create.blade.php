...
@section('title', __('product::messages.create_product'))

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('messages.home') }}</a></li>
        <li class="breadcrumb-item"><a href="{{ route('products.index') }}">{{ __('product::messages.products') }}</a></li>
        <li class="breadcrumb-item active">{{ __('product::messages.add') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('product::messages.create_product') }} <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="category_id" id="category_id" required>
                                            <option value="" selected disabled>{{ __('product::messages.select_category') }}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_barcode_symbology" id="barcode_symbology" required>
                                            <option value="" selected disabled>{{ __('product::messages.select_symbology') }}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            <option value="" selected>{{ __('product::messages.select_tax_type') }}</option>
                                            <option value="1">{{ __('product::messages.exclusive') }}</option>
                                            <option value="2">{{ __('product::messages.inclusive') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
